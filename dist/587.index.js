...
const ruleset_1 = __webpack_require__(3007);
...
var middlewareHostHeader = __webpack_require__(6927);
var middlewareLogger = __webpack_require__(8691);
var middlewareRecursionDetection = __webpack_require__(1619);
var middlewareUserAgent = __webpack_require__(4787);
var configResolver = __webpack_require__(705);
var core = __webpack_require__(6683);
...
var middlewareRetry = __webpack_require__(6433);
var smithyClient = __webpack_require__(6221);
var httpAuthSchemeProvider = __webpack_require__(7672);
var runtimeConfig = __webpack_require__(4825);
...
const package_json_1 = tslib_1.__importDefault(__webpack_require__(9706));
const core_1 = __webpack_require__(3475);
...
const runtimeConfig_shared_1 = __webpack_require__(6670);
...
const httpAuthSchemeProvider_1 = __webpack_require__(7672);
const endpointResolver_1 = __webpack_require__(62);
const getRuntimeConfig = (config) => {
    return {
...
var client = __webpack_require__(1539);
var tokenProviders = __webpack_require__(3723);
...
const resolveSSOCredentials = async ({ ssoStartUrl, ssoSession, ssoAccountId, ssoRegion, ssoRoleName, ssoClient, clientConfig, parentClientConfig, callerClientConfig, profile, filepath, configFilepath, ignoreCache, logger, }) => {
    ...
    const { SSOClient, GetRoleCredentialsCommand } = await Promise.resolve().then(function () { return __webpack_require__(8938); });
    const sso = ssoClient ||
...
var clientSso = __webpack_require__(4295);
...
var client = __webpack_require__(1539);
var httpAuthSchemes = __webpack_require__(8766);
var propertyProvider = __webpack_require__(5169);
var sharedIniFileLoader = __webpack_require__(3628);
...
const getSsoOidcClient = async (ssoRegion, init = {}, callerClientConfig) => {
    const { SSOOIDCClient } = await __webpack_require__.e(/* import() */ 541).then(__webpack_require__.t.bind(__webpack_require__, 4541, 19));
...
const getNewSsoOidcToken = async (ssoToken, ssoRegion, init = {}, callerClientConfig) => {
    const { CreateTokenCommand } = await __webpack_require__.e(/* import() */ 541).then(__webpack_require__.t.bind(__webpack_require__, 4541, 19));
